...
def get_first_profile_id(service):
    ...
    #    account = accounts.get('items')[0].get('id')
        ...
        for property in properties.get('items', []):
            property_result.append((property.get('id'), property.get('name'),property.get('websiteUrl'), property.get('profileCount'), property.get('level'), property.get('created'), property.get('updated')))
        print(property_result)
            #print ('Property ID    = %s' % property.get('id'))
            #print ('Property Name  = %s' % property.get('name'))
            #property_result.property.get('id').append(value)
            #result.property.get('name').append(value)
#        for property in properties.get('items', []):
